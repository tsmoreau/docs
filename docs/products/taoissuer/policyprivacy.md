...
### INTRODUCTION
Welcome to TaoIssuer, a free, open-source, client-side tool for interacting with the blockchain. Tao values privacy and we make a concerted effort to minimize and, to the extent possible, eliminate the exposure of personal data during the use of our interface. TaoIssuer does not collect, hold, or store keys, account information, or passwords. We do not collect data passively, do not monetize the collection of data, and do not use your data for marketing or advertising.

To the extent we collect any personal information, this privacy policy (“Policy”) describes how TaoIssuer collects, uses, and shares personal information of people who visit our website (the “Site”), use our mobile application, TaoIssuer (the “App”), or otherwise use our services (collectively, the “Services”).
...
We may collect Personal Information you choose to provide to us. For example, when you contact us for support through the Services, you give us with your e-mail address and any other information that you choose to provide. Also, if you participate in a TaoIssuer offer, give-away, or promotion (“Promotion”), you provide your name, e-mail address, and mailing address.

California Do Not Track Disclosures

TaoIssuer does not track users over time and across third party websites to provide targeted advertising and therefore does not respond to Do Not Track (DNT) signals.
...
We may share the Personal Information we collect from and about you (1) to fulfill the purpose for which you provided it; (2) with your consent; (3) for legal, protection, and safety purposes; (4) to comply with any court order, law, or legal process, including to respond to any government or regulatory request; (5) to protect the rights of TaoIssuer, our agents, customers, and others, including by enforcing our agreements, policies, and terms of service; and (6) with those who need it to do work for us (our Service Providers, as defined below).
...
Requests in relation to the above rights should be sent to: admin@tao.network
...
### CONTACT INFORMATION
We welcome your comments or questions about this Policy. You may contact us at admin@tao.network
