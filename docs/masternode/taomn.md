...
![taomn python](/assets/tmn_python.png)
...
![taomn docker key](/assets/tmn_key.png)
...
When you first start your full node with taomn, you need to give some information.
...
```
taomn start --name [YOUR_NODE_NAME] --net testnet --pkey [YOUR_COINBASE_PRIVATE_KEY] --api
```
...
![taomn stats](/assets/tmn_stats.png)
